...
export default function AboutSection({ onTabClick }: Props) {
  ...
  return (
    <div className="flex flex-col items-start justify-start mx-5 border-t py-24">
      ...
      <p className="text-2xl leading-snug opacity-60 whitespace-pre-line mb-8 max-w-[1500px]" ref={bioRef}>{Intro.bio}</p>
      <button className="text-2xl button" onClick={() => onTabClick(6)} ref={ctaRef}>
