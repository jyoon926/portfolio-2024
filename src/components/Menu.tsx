...
export default function Menu({ currentSection, onTabClick }: Props) {
  ...
  return (
    <div className="fixed w-full flex flex-row gap-6 p-3 items-start justify-between z-40 backdrop-blur-md bg-background/70 border-b text-nowrap">
      <button onClick={() => handleTabClick(0)}>Jacob Yoon<span className='hidden sm:inline opacity-50'> — Software Engineer</span></button>
      <div className="flex flex-row gap-1 items-start overflow-x-scroll overflow-y-hidden scrollbar-hidden">
