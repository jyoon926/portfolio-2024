      ...
      <div className="min-h-screen w-full flex flex-col md:flex-row items-start justify-start gap-10 p-3 pt-20">
        ...
        <div className="w-full md:w-2/3 flex flex-col items-start gap-3 pb-20">
          <p className="max-w-[800px] leading-snug">
            I am a fourth-year computer science student at RIT pursuing a combined BS/MS degree. I've cultivated a
            strong foundation in both theoretical knowledge and practical application. My academic journey has been
            complemented by two six-month co-ops as a software engineer intern at Dassault Systèmes, where I gained
            extensive hands-on industry experience in full stack development. My love for art and design enhances my
            ability to create digital experiences that are not only functionally robust but also visually compelling.
            Whether it's building responsive web applications or solving complex technical challenges, I approach every
            project with a growth mindset, continuously seeking to improve and innovate.
          </p>
